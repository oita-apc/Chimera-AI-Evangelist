...
import { HttpClient, HttpHeaders, HttpErrorResponse, HttpRequest, HttpEvent, HttpParams } from '@angular/common/http';
...
export class RestApiService {
  ...
  getActiveModel (): Observable<string> {
    return this.http.get<string>(this.baseUrl + '/api/ImageUploader/GetActiveModel')
  }

  getLabel (id): Observable<string> {
    var params = new HttpParams().set('id', id);
    return this.http.get<string>(this.baseUrl + '/api/ImageUploader/GetLabel', {params: params})
  }

  upload(file: any, userName, attribute, imagedate): Observable<HttpEvent<any>> {
