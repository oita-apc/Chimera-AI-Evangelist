...
"""
faster r-cnn using detectron
see https://www.kaggle.com/vbookshelf/basics-of-detectron2-balloon-detection/notebook
"""
...
if __name__ == "__main__":
    ...
    max_iterations = 10
    # working_directory = "/home/buser/project/workspace-test-v1/mlapp/working_directory_balloon"
    ...
    #     args=(args, image_size, batch_size, ),
    # )
    try: 
        register_coco_instances("my_dataset_train", {}, working_directory + "/train.json", working_directory + "/images")
        register_coco_instances("my_dataset_val", {}, working_directory + "/val.json", working_directory + "/images")
        ...
        with open(os.path.join(working_directory, "labels.json")) as f:
                    labelJson = json.load(f) 
        import plotmetrics
        plotmetrics.plot_metrics(working_directory, working_directory, labelJson, max_iterations, 'faster_rcnn')
