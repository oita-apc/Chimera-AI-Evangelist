...
def setup(working_directory, image_size, batch_size, max_iterations):
    ...
    cfg.MODEL.POINT_HEAD.NUM_CLASSES = number_classes
...
if __name__ == "__main__":
    ...
    try: 
        ...
        with open(os.path.join(working_directory, "labels.json")) as f:
                    labelJson = json.load(f) 
        import plotmetrics
        plotmetrics.plot_metrics(working_directory, working_directory, labelJson, max_iterations, 'pointrend')
