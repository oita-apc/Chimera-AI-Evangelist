...
based on TridentNet/train_net.py
"""
...
def setup(working_directory, image_size, batch_size, max_iterations):
    ...
    # cfg.OUTPUT_DIR = "" # TODO: set output directory
...
if __name__ == "__main__":
    ...
    try: 
        ...
        working_directory = "/data/workspace-matterport"
        register_coco_instances("my_dataset_train", {}, "/data/workspace-matterport/dataset_production/train.json", "/data/workspace-matterport/dataset_production/dataset/images")
        register_coco_instances("my_dataset_val", {}, "/data/workspace-matterport/dataset_production/val.json", "/data/workspace-matterport/dataset_production/dataset/images")
        ...
        import plotmetrics
        plotmetrics.plot_metrics(working_directory, working_directory, labelJson, max_iterations, 'trident')
